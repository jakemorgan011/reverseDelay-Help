...
public:
    ...
    void drawRotarySlider(juce::Graphics& g, int x, int y, int width, int height, float sliderPos, float rotaryStartAngle, float rotaryEndAngle, juce::Slider& slider){
        ...
        auto sprite = juce::ImageCache::getFromMemory(BinaryData::LeKnob_png, BinaryData::LeKnob_pngSize);
        ...
        g.drawImage(sprite, 0, 0, sliderWidth, 80, 0, start_y, image_width, sliderHeight);
    }
